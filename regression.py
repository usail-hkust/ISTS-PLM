...
if __name__ == '__main__':
	...
	if(args.n < 12000):
		...
		log_path = f"logs/{args.task}_{args.dataset}_{args.model}_{args.state}_history{args.history}_plmlayer{args.n_te_plmlayer}_{args.n_st_plmlayer}_lr{args.lr}.log"
