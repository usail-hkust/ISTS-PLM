...
class GPT2PreTrainedModel(PreTrainedModel):
    ...
    def _set_gradient_checkpointing(self, module, value=False):
        if isinstance(module, GPT2Model_wope):
...
class GPT2Model_wope(GPT2PreTrainedModel):
    ...
    def parallelize(self, device_map=None):
        ...
        warnings.warn(
            "`GPT2Model_wope.parallelize` is deprecated and will be removed in v5 of Transformers, you should load your"
...
class GPT2LMHeadModel(GPT2PreTrainedModel):
    ...
    def __init__(self, config):
        super().__init__(config)
        self.transformer = GPT2Model_wope(config)
